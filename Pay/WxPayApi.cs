...
namespace OxetekWeChatSDK.Pay
{
    public class WxPayApi
    {
        ...
        //* @return 成功时返回，其他抛异常
        //*/
        //public static WxPayData ShortUrl(WxPayData inputObj,string appId,string mchId, int timeOut = 6)
        //{
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, string appId, string mchId, string mchKey, string notifyUrl, int timeOut = 6)
        {
        ...
        */
        ...
        public static string BizPayUrl(WxPayData payData)
        {

            return $"{payData.ToUrl()}&sign={payData.MakeSign()}";
        }
    }
}
